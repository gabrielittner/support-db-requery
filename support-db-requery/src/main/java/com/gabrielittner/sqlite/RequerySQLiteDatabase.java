...
class RequerySQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public RequerySQLiteDatabase(SQLiteDatabase delegate) {
        mDelegate = delegate;
    }

    @Override
    public SupportSQLiteStatement compileStatement(String sql) {
        return new RequerySQLiteStatement(mDelegate.compileStatement(sql));
    }
    ...
    public Cursor query(final SupportSQLiteQuery supportQuery) {
        return mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
            ...
            public Cursor newCursor(SQLiteDatabase db, SQLiteCursorDriver masterQuery,
                ...
                supportQuery.bindTo(new RequerySQLiteProgram(query));
    ...
    public Cursor query(final SupportSQLiteQuery supportQuery,
        ...
        final android.support.v4.os.CancellationSignal supportCancellationSignal = new android.support.v4.os.CancellationSignal();
        ...
        }, supportQuery.getSql(), EMPTY_STRING_ARRAY, null, supportCancellationSignal);
    }
